...
/********************************************************/
	...
	$GLOBALS['lsPluginPath'] = THEME_PLUGINS_URI . '/layerslider/';
...
function layerslider_settings_menu() {
	...
	$layerslider_hook = add_menu_page('Layer Slider', 'Layer Slider', 'manage_options', 'layerslider', 'layerslider_router',  THEME_ADMIN_ASSETS_URI . '/images/layerslider-admin-icon.png');
