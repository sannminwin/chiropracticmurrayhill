...
class RevSlider_Widget extends WP_Widget {
    ...
    public function __construct(){
        ...
        // widget actual processes
     	$widget_ops = array('classname' => 'widget_revslider', 'description' => __('Displays a revolution slider on the page', 'backend') );
        parent::__construct('rev-slider-widget', THEME_SLUG.' - ' . __('Revolution Slider', 'backend'), $widget_ops);
    }
    ...
    public function form($instance) {
		...
		if(empty($arrSliders))
			echo __("No sliders found, Please create a slider", 'backend');
		else{
