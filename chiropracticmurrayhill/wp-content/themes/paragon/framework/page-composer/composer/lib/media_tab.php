...
class WPBakeryImagesMediaTab extends WPBakeryMediaTab {
    ...
    public function getMediaItem( $attachment_id, $args = null) {
        if ( ( $attachment_id = intval( $attachment_id ) ) && $thumb_url = wp_get_attachment_image_src( $attachment_id, Array(160,160) ) )
    ...
    public function getContentList() {
        ...
        if ( $page_links )
            echo '<br/><div class="tablenav"><div id="wpb_spinner" style="display: none;"><img src="'.THEME_ADMIN_ASSETS_URI.'/images/mk-loading.gif" /> '.__("Loading, please wait...", "js_composer").'</div><div class="tablenav-pages">' . $page_links . '</div></div>';
