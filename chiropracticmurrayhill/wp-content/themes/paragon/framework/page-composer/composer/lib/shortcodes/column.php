...
class WPBakeryShortCode_VC_Column extends WPBakeryShortCode {
    ...
    public function content( $atts, $content = null ) {
        ...
        $output .= "\n\t".'<div class="wpb_content_element '.$width.$el_class.' '.$el_position_css.'">';
    ...
    public function contentAdmin($atts, $content = null) {
        ...
        for ( $i=0; $i < count($width); $i++ ) {
            $output .= '<div data-element_type="'.$this->settings["base"].'" class="wpb_vc_column wpb_content_element wpb_sortable wpb_droppable '.$width[$i].' not-column-inherit">';
