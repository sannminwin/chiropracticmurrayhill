...
/*
	FLICKR WIDGET
*/
class Artbees_Widget_pinterest_feeds extends WP_Widget {

	function Artbees_Widget_pinterest_feeds() {
		$widget_ops = array( 'classname' => 'widget_pinterest', 'description' => 'Displays photos from Pinterest' );
		$this->WP_Widget( 'pinterest', THEME_SLUG.' - '.'Pinterest', $widget_ops );
	...
	function widget( $args, $instance ) {
		extract( $args );
		$title = apply_filters( 'widget_title', empty( $instance['title'] ) ? 'Photos on pinterest' : $instance['title'], $instance, $this->id_base );
...
?>
		...
		jQuery(document).ready(function(){
		  ...
		  jQuery("#pinterest_feed_<?php echo $id; ?>").photostream_widget({
		...
		<div id="pinterest_feed_<?php echo $id; ?>" class="pinterest-widget-wrapper">
