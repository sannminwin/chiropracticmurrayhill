...
$font_replacement_objects = array(
    ...
    '.mk-fancy-text' => "Fancy Text Shortcode",
    ...
    '.client-title' => 'Clients Shortcode Title',
    '.mk-banner-text-caption' => 'Banner Text Shortcode Text',
    '.mk-tabs-tabs a' => 'Tabs Shortcode',
    '.mk-accordion-tab' => 'Accordion Shortcode',
    '.mk-toggle-title' => 'Toggle Shortcode',
    '#cboxTitle' => 'Lightbox Title',
    ...
    '.mk-fancy-divider' => 'Fancy Divider Shortcode',
    '.mk-dropcaps' => 'Dropcaps Shortcode',
    '.big-numbers-count' => 'Big Numbers',
    '.widget-sub-navigation ul li a'=> 'Sub Navigation Widget',
    '.pinterest-widget-title' => 'Pinterest Widget Items Title',
    '.woocommerce ul.products li.product .price, .woocommerce-page ul.products li.product .price' => 'Woocommerce - Price',
    '.woocommerce .mk-onsale' => 'Woocommerce - On Sale badge'
