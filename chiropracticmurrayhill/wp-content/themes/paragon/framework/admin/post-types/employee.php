...
function edit_employees_columns($employee_columns) {
	$columns = array(
		...
		'title' => __('Employee Name', 'backend'),
		"position" => __('Position', 'theme_frontend' ),
...
function register_employees_post_type(){
	register_post_type('employees', array(
		'labels' => array(
			'name' => __('Employees','theme_frontend'), __('post type general name','theme_frontend'),
			'singular_name' => __('Team Member','theme_frontend'), __('post type singular name','theme_frontend'),
			'add_new' => __('Add New Memeber','theme_frontend'), __('employees','theme_frontend'),
			'add_new_item' => __('Add New Team Member', 'backend'),
			'edit_item' => __('Edit Team Member','theme_frontend'),
			'new_item' => __('New Team Member','theme_frontend'),
			'view_item' => __('View Team Member','theme_frontend'),
			'search_items' => __('Search Team Members','theme_frontend'),
			'not_found' =>  __('No Team Member found','theme_frontend'),
			'not_found_in_trash' => __('No Team Members found in Trash','theme_frontend'),
			'parent_item_colon' => '',
