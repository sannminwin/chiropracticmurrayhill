...
jQuery(function($) {
        //Collor Selector
        $('.colorselector .colsel').live('click',function(){
            $('.colorselector .colorsboxes').toggle();
            var sitelink = $('.logo a').attr('href');

            $('.orangecol').click(function(){
               $('#aletheme_general_css-css').attr('href',''+sitelink+'/wp-content/themes/socha/css/colors/orange/general.css')
            });
            $('.redcol').click(function(){
                $('#aletheme_general_css-css').attr('href',''+sitelink+'/wp-content/themes/socha/css/colors/red/general.css')
            });
            $('.blackcol').click(function(){
                $('#aletheme_general_css-css').attr('href',''+sitelink+'/wp-content/themes/socha/css/colors/black/general.css')
            });
            $('.bluecol').click(function(){
                $('#aletheme_general_css-css').attr('href',''+sitelink+'/wp-content/themes/socha/css/colors/blue/general.css')
            });
            $('.greencol').click(function(){
                $('#aletheme_general_css-css').attr('href',''+sitelink+'/wp-content/themes/socha/css/colors/green/general.css')
            });
            $('.purplecol').click(function(){
                $('#aletheme_general_css-css').attr('href',''+sitelink+'/wp-content/themes/socha/css/colors/purple/general.css')
            });
        });
