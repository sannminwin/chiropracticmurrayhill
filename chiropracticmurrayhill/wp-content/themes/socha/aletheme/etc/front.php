...
function ale_enqueue_styles() {
    ...
    wp_register_style( 'aletheme_general_red_css', THEME_URL . '/css/colors/red/general.css', array(), ALETHEME_THEME_VERSION, 'all');
    wp_register_style( 'aletheme_general_blue_css', THEME_URL . '/css/colors/blue/general.css', array(), ALETHEME_THEME_VERSION, 'all');
    wp_register_style( 'aletheme_general_black_css', THEME_URL . '/css/colors/black/general.css', array(), ALETHEME_THEME_VERSION, 'all');
    wp_register_style( 'aletheme_general_green_css', THEME_URL . '/css/colors/green/general.css', array(), ALETHEME_THEME_VERSION, 'all');
    wp_register_style( 'aletheme_general_purple_css', THEME_URL . '/css/colors/purple/general.css', array(), ALETHEME_THEME_VERSION, 'all');

    if(ale_get_option('site_color')) {
        if(ale_get_option('site_color')=='red') {
            wp_enqueue_style('aletheme_general_red_css');
        } elseif (ale_get_option('site_color')=='blue') {
            wp_enqueue_style('aletheme_general_blue_css');
        } elseif (ale_get_option('site_color')=='black') {
            wp_enqueue_style('aletheme_general_black_css');
        } elseif (ale_get_option('site_color')=='green') {
            wp_enqueue_style('aletheme_general_green_css');
        } elseif (ale_get_option('site_color')=='orange') {
            wp_enqueue_style('aletheme_general_css');
        } elseif (ale_get_option('site_color')=='purple') {
            wp_enqueue_style('aletheme_general_purple_css');
        } else {
            wp_enqueue_style('aletheme_general_css');
        }
    } else {
...
function ale_enqueue_scripts() {
	...
	if (ALETHEME_MODE == 'production') {
		wp_register_script( 'ale_plugins', THEME_URL . '/js/plugins.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, false );
		wp_register_script( 'ale_scripts', THEME_URL . '/js/scripts.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, false );
	} else {
		wp_register_script( 'ale_plugins', THEME_URL . '/js/plugins.js', array( 'jquery' ), ALETHEME_THEME_VERSION, false );
    ...
    wp_register_script( 'jquery.mousewheel', THEME_URL . '/js/libs/jquery.mousewheel.js', array( 'jquery' ), ALETHEME_THEME_VERSION, false );
    wp_register_script( 'mwheelIntent', THEME_URL . '/js/libs/mwheelIntent.js', array( 'jquery' ), ALETHEME_THEME_VERSION, false );
    wp_register_script( 'jquery.jscrollpane.min', THEME_URL . '/js/libs/jquery.jscrollpane.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, false );
    wp_register_script( 'jquery.isotope.min', THEME_URL . '/js/libs/jquery.isotope.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, false );
    wp_register_script( 'scrollable', THEME_URL . '/js/libs/scrollable.js', array( 'jquery' ), ALETHEME_THEME_VERSION, false );
    wp_register_script( 'jquery.nivo.slider.pack', THEME_URL . '/js/libs/jquery.nivo.slider.pack.js', array( 'jquery' ), ALETHEME_THEME_VERSION, false );
    ...
    //Get Isotope on Blog or Post Type Blog Pages
    if ( is_post_type_archive('inspiration') or is_page_template('template-gallery-filter.php') or is_blog () or is_search() or is_post_type_archive('press') or is_post_type_archive('video') or is_post_type_archive('gallery') or is_post_type_archive('testimonials') or is_page_template('template-gallery-pagination.php') or is_page_template('template-blog.php')) {
